...
// Getter for Zod schemas to be used in server actions.
export const getCiscoIPPhoneMenuSchema = () => CiscoIPPhoneMenuSchema;
export const getCiscoIPPhoneDirectorySchema = () => CiscoIPPhoneDirectorySchema;
